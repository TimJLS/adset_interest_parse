...
# _facebook_data_collect_dev_py="/home/tim_su/ai_optimizer/opt/ai_optimizer/ai_optimizer/codes/facebook_datacollector_test.py"
...
# python3 $_facebook_data_collect_dev_py  >> $_facebook_data_collect_log
