...
class ReportGenerator(object):
    ...
    def get_insights(self, date_preset):
        ...
        data_df.rename( columns=dict(zip(data_df.columns, self._columns)), inplace=True)
...
class CampaignReportGenerator(ReportGenerator):
    ...
    def __init__(self, campaign_id, media):
        ...
        self.__init_report()
        self.__init__selector_fields()
        
    def __init__selector_fields(self):
        self.report.selector_object.spec['fields'] = self._fields
