...
#     print(life_time_campaign_insights)
    ...
    for adset_id in adset_list:
        ...
        try:
            ...
            df_adset = pd.DataFrame(adset_dict, index=[0])
            data_base_fb.upsert("adset_initial_bid", { key : adset_dict[key] for key in [ Field.campaign_id, Field.adset_id, Field.bid_amount ] })
        except Exception as e:
...
#!jupyter nbconvert --to script facebook_datacollector_test.ipynb
